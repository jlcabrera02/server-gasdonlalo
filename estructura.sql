...
CREATE TABLE IF NOT EXISTS `info_lecturas` (
  ...
  INDEX `fk_info_lecturas_horarios1_idx` (`idhorario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `lecturas_finales` (
  ...
  PRIMARY KEY (`lectura`, `idinfo_lectura`),
  INDEX `fk_lecturas_mangueras1_idx` (`idmanguera` ASC) VISIBLE,
  INDEX `fk_lecturas_finales_info_lecturas1_idx` (`idinfo_lectura` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `lecturas` (
  ...
  INDEX `fk_lecturas_liquidaciones1_idx` (`idliquidacion` ASC) VISIBLE)
ENGINE = InnoDB;
