...
CREATE TABLE IF NOT EXISTS `trabajos_mantenimiento` (
  `idtmantenimiento` INT NOT NULL AUTO_INCREMENT,
  `area_mantenimiento` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`idtmantenimiento`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ordenes_trabajo` (
  ...
  `updatedAt` DATETIME NOT NULL DEFAULT currrent_timestamp(),
