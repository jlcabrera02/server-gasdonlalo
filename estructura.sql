...
CREATE TABLE IF NOT EXISTS `precios` (
  ...
  CONSTRAINT `fk_precios_gas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_precios_empleado1`
    FOREIGN KEY (`idempleado_captura`)
    REFERENCES `gasdonlalo`.`empleado` (`idempleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `islas` (
  ...
  CONSTRAINT `fk_islas_estacion_servicio1`
    FOREIGN KEY (`idestacion_servicio`)
    REFERENCES `gasdonlalo`.`estacion_servicio` (`idestacion_servicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mangueras` (
  ...
  `contadorMaximo` INT NULL DEFAULT 999999,
  `nreinicio` INT NULL DEFAULT 0,
  ...
  CONSTRAINT `fk_islas_has_gas_islas1`
    FOREIGN KEY (`idisla`)
    REFERENCES `islas` (`idisla`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_islas_has_gas_gas1`
    FOREIGN KEY (`idgas`)
    REFERENCES `gas` (`idgas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `auditorias` (
  ...
  CONSTRAINT `fk_auditorias_empleado1`
    FOREIGN KEY (`idempleado`)
    REFERENCES `gasdonlalo`.`empleado` (`idempleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `lecturas_iniciales`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `lecturas_iniciales` ;

CREATE TABLE IF NOT EXISTS `lecturas_iniciales` (
  ...
  INDEX `fk_lecturas_mangueras1_idx` (`idmanguera` ASC) VISIBLE,
  CONSTRAINT `fk_lecturas_mangueras1`
    FOREIGN KEY (`idmanguera`)
    REFERENCES `mangueras` (`idmanguera`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `horarios` (
  ...
  CONSTRAINT `fk_horarios_turno1`
    FOREIGN KEY (`idturno`)
    REFERENCES `turno` (`idturno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_horarios_empleado1`
    FOREIGN KEY (`idempleado`)
    REFERENCES `gasdonlalo`.`empleado` (`idempleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_horarios_estacion_servicio1`
    FOREIGN KEY (`idestacion_servicio`)
    REFERENCES `gasdonlalo`.`estacion_servicio` (`idestacion_servicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `liquidaciones` (
  ...
  INDEX `fk_liquidaciones_horarios1_idx` (`folio` ASC) VISIBLE,
  PRIMARY KEY (`folio`),
  INDEX `fk_liquidaciones_empleado1_idx` (`idempleado_captura` ASC) VISIBLE,
  CONSTRAINT `fk_liquidaciones_horarios1`
    FOREIGN KEY (`folio`)
    REFERENCES `horarios` (`idhorario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_liquidaciones_empleado1`
    FOREIGN KEY (`idempleado_captura`)
    REFERENCES `gasdonlalo`.`empleado` (`idempleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `vales` (
  ...
  INDEX `fk_vales_liquidaciones1_idx` (`folio` ASC) VISIBLE,
  CONSTRAINT `fk_vales_gas1`
    FOREIGN KEY (`combustible`)
    REFERENCES `gas` (`idgas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vales_liquidaciones1`
    FOREIGN KEY (`folio`)
    REFERENCES `liquidaciones` (`folio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `efectivo` (
  ...
  INDEX `fk_efectivo_liquidaciones1_idx` (`folio` ASC) VISIBLE,
  CONSTRAINT `fk_efectivo_liquidaciones1`
    FOREIGN KEY (`folio`)
    REFERENCES `liquidaciones` (`folio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `lecturas` (
  `idlectura` INT NOT NULL AUTO_INCREMENT,
  `manguera` VARCHAR(3) NULL,
  `lecturaInicial` INT NOT NULL,
  `lecturaFinal` INT NOT NULL,
  `precio` DECIMAL(10,2) NOT NULL,
  `folio` INT NOT NULL,
  PRIMARY KEY (`idlectura`),
  INDEX `fk_lecturas_liquidaciones1_idx` (`folio` ASC) VISIBLE,
  CONSTRAINT `fk_lecturas_liquidaciones1`
    FOREIGN KEY (`folio`)
    REFERENCES `liquidaciones` (`folio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `nominas` (
  ...
  INDEX `fk_nominas_tipo_nomina1_idx` (`idtipo_nomina` ASC) VISIBLE,
  INDEX `fk_nominas_empleado1_idx` (`idempleado` ASC) VISIBLE,
  CONSTRAINT `fk_nominas_tipo_nomina1`
    FOREIGN KEY (`idtipo_nomina`)
    REFERENCES `tipos_nominas` (`idtipo_nomina`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `detalles` (
  ...
  CONSTRAINT `fk_nomina_empleado_empleado1`
    FOREIGN KEY (`idempleado`)
    REFERENCES `gasdonlalo`.`empleado` (`idempleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_nomina_empleado_tipos_nominas1`
    FOREIGN KEY (`idtipo_nomina`)
    REFERENCES `tipos_nominas` (`idtipo_nomina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
