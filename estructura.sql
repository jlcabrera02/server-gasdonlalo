...
-- Table `islas_has_gas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `islas_has_gas` ;

CREATE TABLE IF NOT EXISTS `islas_has_gas` (
  `idisla` INT NOT NULL,
  `idgas` CHAR NOT NULL,
  `tiene` BIT NOT NULL DEFAULT 1,
  PRIMARY KEY (`idisla`, `idgas`),
...
CREATE TABLE IF NOT EXISTS `lecturas` (
  ...
  INDEX `fk_lecturas_islas_has_gas1_idx` (`idisla` ASC, `idgas` ASC) VISIBLE)
ENGINE = InnoDB;
