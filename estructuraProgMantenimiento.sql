...
CREATE TABLE IF NOT EXISTS `pronosticos` (
  ...
  `existencia_litros` DECIMAL(19,2) NOT NULL,
  `compra_litros` DECIMAL(19,2) NULL,
  `ventas_litros` DECIMAL(19,2) NOT NULL,
  `idestacion_servicio` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `dias_no_favorables`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dias_no_favorables` ;

CREATE TABLE IF NOT EXISTS `dias_no_favorables` (
  `fecha` DATE NOT NULL)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fechas_actividades`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fechas_actividades` ;

CREATE TABLE IF NOT EXISTS `fechas_actividades` (
  ...
  INDEX `fk_fechas_actividades_actividades1_idx` (`idactividad` ASC) VISIBLE,
  INDEX `fk_fechas_actividades_ordenes_trabajo1_idx` (`id_ot` ASC) VISIBLE)
ENGINE = InnoDB;
