...
model.findRecursos = () =>
  new Promise((resolve, reject) => {
    let sql = `SELECT re.* emp.nombre, emp.apellido_paterno, emp.apellido_materno FROM recursos_entrega re, empleado emp WHERE re.idempleado_recibe = emp.idempleado ORDER BY re.fecha`;
