...
model.update = (data) =>
  new Promise((resolve, reject) => {
    let sql =
      "UPDATE otrabajo_mantenimiento SET ? WHERE idotrabajmantenimiento = ?";
...
model.delete = (id) =>
  new Promise((resolve, reject) => {
    let sql =
      "DELETE FROM otrabajo_mantenimiento WHERE idotrabajmantenimiento = ?";
