...
("jose", "jose@donlalo.com.mx", MD5("jose2023"), CURRENT_TIME, 59),
...
(11, "Obtener y capturar datos", "Recolección Efectivo", 2, "Das permiso de que el usuario pueda ver y capturar datos"),
(12, "Actualizar", "Recolección Efectivo", 2, "Das permiso de que el usuario pueda actualizar"),
(13, "Eliminar", "Recolección Efectivo", 2, "Das permiso de que el usuario pueda eliminar"),
...
(24, "Obtener", "Recursos Humanos", 7, "Das permiso de que el usuario obtener las solicitudes de empleo"),
(25, "Capturar", "Recursos Humanos", 7, "Das permiso de que el usuario crear solicitudes de empleo"),
(26, "Dar de baja", "Recursos Humanos", 7, "Das permiso de que el usuario pueda manipular las solicitudes"),
(27, "Obtener documentos", "Recursos Humanos", 7, "El usuario puede visualizar que documentos tienen en la empresa del empleado"),
(28, "Manipular documentos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda marcar si la empresa  documentos personales del empleado"),
(29, "Obtener faltas y retardos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda obtener las entradas del empleado"),
(30, "Capturar faltas y retardos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda capturar las entradas del empleado"),
(31, "Actualizar faltas y retardos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda actualizar las entradas del empleado"),
(32, "Eliminar faltas y retardos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda eliminar las entradas del empleado"),
(33, "Obtener venta litros", "Recursos Humanos", 7, "Das permiso de que el usuario pueda obtener las ventas de listros"),
(34, "Capturar venta litros", "Recursos Humanos", 7, "Das permiso de que el usuario pueda capturar venta de litros"),
(35, "Actualizar venta litros", "Recursos Humanos", 7, "Das permiso de que el usuario pueda actualizar venta de litros"),
(36, "Eliminar venta litros", "Recursos Humanos", 7, "Das permiso de que el usuario pueda eliminar venta de litros"),
(37, "Obtener venta de aceites", "Recursos Humanos", 7, "Das permiso de que el usuario pueda obtener las ventas de aceites"),
(38, "Capturar venta de aceites", "Recursos Humanos", 7, "Das permiso de que el usuario pueda capturar venta de aceites"),
(39, "Actualizar venta de aceites", "Recursos Humanos", 7, "Das permiso de que el usuario pueda actualizar venta de aceites"),
(40, "Eliminar venta de aceites", "Recursos Humanos", 7, "Das permiso de que el usuario pueda eliminar venta de aceites"),
(41, "Obtener entrega de recursos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda ver entrega recursos"),
(42, "Capturar entrega de recursos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda capturar las entrega recursos"),
(43, "Actualizar entrega de recursos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda actuualizar las entregas de recursos"),
(44, "Eliminar entrega de recursos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda eliminar las entregas de recursos"),
(45, "Crear departamentos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda crear nuevos departamentos"),
(46, "Actualizar departamentos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda actualizar departamentos"),
(47, "Eliminar departamentos", "Recursos Humanos", 7, "Das permiso de que el usuario pueda eliminar departamentos"),
